        ...
        <div class="videoBanner videoBannerOne videoBannerLarge content-style">
            <div class="videoBannerWrap"
                ...
                <video autoplay="autoplay" loop="loop" muted="muted"
                    poster="{{ asset('frontend/files/galleries/BFC_Video_Placeholder.jpg') }}" data-fit-img-child>
                    <source src="{{ asset('frontend/files/galleries/Sequence_01.webm') }}" type="video/mp4" />
                ...
                <div class="playbutton"><a href="%7bvideoBanner_fulllength%7d.html" class="video-popup"><img
